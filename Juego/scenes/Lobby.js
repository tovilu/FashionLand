class Lobby extends Phaser.Scene 
{
    ...
    create() 
    {
        ...
        this.copa2 = this.add.image(game.canvas.width * 58 / 100, game.canvas.height * 59 / 100, 'copa2').setInteractive();
    ...
    terminar()
    {
        ...
        this.boton = 1;
        if (this.camisetaActual == null || this.pantalonActual == null || this.gorroActual == null || this.zapatoActual == null)
        {
